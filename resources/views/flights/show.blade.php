      ...
      <div class="col-xs-12 col-md-4">
          <div class="card">
              ...
              <div class="card-body flex flex-column items-center gap-1">
                  ...
                  <form class="flex mt-4 gap-1" name="add-user-booking" id="add-user-booking" action="{{ route('vuelos-usuario.store', $flight->id) }}" method="post">
                    @csrf
                    <div class="form-group">
                      <input class="input form-control border border-success" type="number" id="tickets" name="tickets" placeholder="# de tickets">
