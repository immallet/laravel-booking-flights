...
<body class="vh-100 bg-dark antialiased">
    <div id="app">
        <div class="flex flex-column justify-start min-h-screen bg-gray-500 dark:bg-gray-900 py-4 sm:pt-0">
            <nav class="navbar navbar-expand-md navbar-light shadow-sm fixed top-0 right-0 px-6 py-4 sm:block">
                <div class="container">
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="{{ route('vuelos-usuario') }}">
                                            {{ __('Mis reservas') }}
                                        </a>
